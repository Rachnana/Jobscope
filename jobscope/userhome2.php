                  ...
                  if($num > 0)
                  {
                    while(  $data = mysqli_fetch_assoc($connect))
                    {
                        echo "
                            ...
                            <td><a href='apply.php?jobid=$data[jobid] & Title=$data[Title] & cname=$data[name]  & Salary=$data[Salary] & Exprnce=$data[Exprnce] & Eligibility=$data[Eligibility] & City=$data[City] & Description=$data[Description] 'class='statue'>APPLY</a></td>
