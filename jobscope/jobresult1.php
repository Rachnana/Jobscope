                  ...
                  if($num > 0)
                  {
                    while(  $data = mysqli_fetch_assoc($connect))
                    {
                        echo "
                            ...
                            <td>".$data['Hour']."</td>
                            <td><a href='view_applied.php?jobid=$data[jobid]' class='statue'>APPPLIED</a></td>
                            <td><a href='update.php?jobid=$data[jobid] & Title=$data[Title] & Exprnce=$data[Exprnce] & Eligibility=$data[Eligibility] & Salary=$data[Salary] & City=$data[City] & Description=$data[Description] & Hour=$data[Hour]' class='status'>UPDATE</a></td>
